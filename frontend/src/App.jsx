...
function Proximamente({ title }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px', textAlign: 'center' }}>
      ...
      <h2 style={{ fontFamily: 'Antonio, sans-serif', fontSize: '1.5rem', color: '#F0EDE8', marginBottom: '8px' }}>{title}</h2>
      ...
      <AuthProvider>
        <Routes>
          ...
          <Route path="/app" element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
            ...
            {/* Entrenador */}
            <Route path="mis-grupos" element={<Proximamente title="Detalle de Grupos" />} />
